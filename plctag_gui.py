...
def main():
    ...
    lbPLC = Listbox(frame1, height=11, width=9, bg='lightblue')
    lbDataType = Listbox(frame1, height=11, width=10, bg='lightblue')
    lbPID = Listbox(frame1, height=11, width=5, bg='lightblue')
    lbTCC = Listbox(frame1, height=11, width=5, bg='lightblue')
    lbBit = Listbox(frame1, height=11, width=4, bg='lightblue')
    lbStringLength = Listbox(frame1, height=11, width=4, bg='lightblue')
    lbBoolDisplay = Listbox(frame1, height=11, width=7, bg='lightblue')
    ...
    scrollbarDataTypes.pack(anchor='n', side='left', pady=3, ipady=80)
    ...
    if plc_tag_check_lib_version(2, 2, 0) != 0:
        ...
        scrollbarPID.pack(anchor='n', side='left', pady=3, ipady=80)
    ...
    scrollbarTCC.pack(anchor='n', side='left', pady=3, ipady=80)
    ...
    scrollbarBit.pack(anchor='n', side='left', pady=3, ipady=80)
    ...
    scrollbarStringLength.pack(anchor='n', side='left', pady=3, ipady=80)
    ...
    scrollbarTags.pack(anchor='n', side='right', padx=3, pady=3, ipady=80)
    ...
    tbBit = Entry(frame2, justify='center', textvariable=selectedBit, width=5, fg='blue', state='readonly')
    ...
    tbProgramName = Entry(frame2, justify='center', textvariable=selectedProgramName, font='Helvetica 14', relief='raised')
    ...
    frame6 = Frame(root, background='white')
    frame6.pack(side='bottom', fill=X)

    # create a label and an entry box for the IPAddress
    lblIPAddress = Label(frame6, text='IP Address', fg='black', bg='white', font='Helvetica 12')
    lblIPAddress.pack(side='left', padx=55)
    selectedIPAddress = StringVar()
    tbIPAddress = Entry(frame5, justify='center', textvariable=selectedIPAddress, font='Helvetica 14', relief='raised')
    ...
    lblTagStatus = Label(frame5, text=' tag status ', fg='black', bg='red', font='Helvetica 14')
    lblTagStatus.pack(side='left', padx=5)

    # create a label and an entry box for the Path
    lblPath = Label(frame6, text='Path', fg='black', bg='white', font='Helvetica 12')
    lblPath.pack(side='right', padx=70)
    selectedPath = StringVar()
    tbPath = Entry(frame5, justify='center', textvariable=selectedPath, font='Helvetica 14', relief='raised')
    ...
    lblLibraryVersion = Label(frame5, text=' libplctag ' + plctagVersion + ' ', fg='black', bg='white', font='Helvetica 14')
    ...
    lblTag = Label(frame3, text='Tag to Read (optional applicable # elements as {x})', fg='black', bg='white', font='Helvetica 12 italic')
    ...
    tagValue.pack(anchor='center', padx=1, pady=5)
